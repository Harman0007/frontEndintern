...
const id=params.get("q")
  ...
  useEffect(()=>{
   ...
   const response=await axios.get (`https://backend-internarea-xxtu.onrender.com/api/job/${id}`)
...
if (text.value==="") {
  ...
  await axios.post("https://backend-internarea-xxtu.onrender.com/api/application",bodyJson).then((res)=>{
          ...
          Jobs.map((data, index) => (
            <>
              ...
              <div className="m-14 shadow-sm rounded-md border">
                ...
                <p> <i class="bi bi-geo-alt-fill"></i> {data.location}
                </p>
