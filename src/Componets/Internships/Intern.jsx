...
function Intern() {
    ...
    const hidediv = () => {
      ...
      useEffect(()=>{
        const fetchData= async()=>{
            try {
            const response= await axios.get(`https://backend-internarea-xxtu.onrender.com/api/internship`)
    ...
    return (
        ...
        <div className="flex internshi-filter">
            <div className="first-int mb-14">
                <div className="filter-section w-1/6">
                    ...
                    <span className="justfy-end flex text-blue-400 mr-3">Clear all</span>
                </div>
            ...
            <div className="all-internships">
                ...
                <p className="font-bold text-lg">{filterInternship.length} total Interships</p>
                {
